...
export function SettingsPage() {
  ...
  return <div className="page settings-page">
    ...
    <div className="settings-grid">
      ...
      <section className="settings-card action warning"><RefreshCcw /><div><h2>恢复默认题库</h2><p>只恢复 142 道默认题目；不会清空练习历史与每日计划。</p><button className="button danger-button" onClick={() => { if (confirm("恢复默认题库会覆盖当前题库修改，但保留练习历史和每日计划。建议先导出备份。确定继续？")) void resetToDefault(); }}>恢复默认</button></div></section>
    </div>
