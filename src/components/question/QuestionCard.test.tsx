...
describe("QuestionCard", () => {
  it("shows bilingual content and accessible actions", () => {
    ...
    render(<MemoryRouter><QuestionCard question={question} speech={speech} practiceCount={0} practicedToday={false} onFavorite={vi.fn()} /></MemoryRouter>);
    ...
    expect(screen.getByText("○ 未练")).toBeInTheDocument();
  });
});
